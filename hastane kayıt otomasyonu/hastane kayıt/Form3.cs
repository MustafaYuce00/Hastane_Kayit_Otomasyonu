...
namespace hastane_kayıt
{
    public partial class Form3 : Form
    {
        ...
        private void comboBox1_Validated(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Çocuk Hastalıkları Bölümünü Seçtiniz");
            }
            else if (comboBox1.SelectedIndex == 1)
            {
                MessageBox.Show("Dermatoloji Bölümünü Seçtiniz");
            }
            else if (comboBox1.SelectedIndex == 2)
            {
                MessageBox.Show("Göğüs Hastalıkları Bölümünü Seçtiniz");
            }
            else if (comboBox1.SelectedIndex == 3)
            {
                MessageBox.Show("Enfeksyon Hastalıkları Bölümünü Seçtiniz");
            }
            else if (comboBox1.SelectedIndex == 4)
            {
                MessageBox.Show("Dahiliye Bölümünü Seçtiniz");
            }
            else if (comboBox1.SelectedIndex == 5)
            {
                MessageBox.Show("Kardiyoloji Bölümünü Seçtiniz");
            }
            else if (comboBox1.SelectedIndex == 6)
            {
                MessageBox.Show("Nöroloji Bölümünü Seçtiniz");
            }
            else if (comboBox1.SelectedIndex == 7)
            {
                MessageBox.Show("Psikiyatr Bölümünü Seçtiniz");
            }
            else if (comboBox1.SelectedIndex == 8)
            {
                MessageBox.Show("Kulak, Burun, Boğaz Bölümünü Seçtiniz");
            }
            else
            {
